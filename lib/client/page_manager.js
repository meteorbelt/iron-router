...
PageManager.prototype = {
  ...
  _renderTemplate: function (key) {
    ...
    var template = getTemplateFunction(this.yieldsToTemplates.get(key), function () {
      return '';
    });
    var data = this.getData();
    var helpers = this.helpers();
    var dataContext = _.extend({}, data, helpers);
    return template.withData(dataContext);
  },
  ...
  renderLayout: function () {
    ...
    return UI.render(layout.withData(dataContext));
  },
